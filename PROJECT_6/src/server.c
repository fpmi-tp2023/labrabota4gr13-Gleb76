...
void create_insert_query(char *query) {
            ...
            string_concat(query, COMMA');
                          ...
                          input_str_field(query, str_buffer, FLOOR);
                          input_str_field(query, str_buffer, NATIONALITY);
                          input_int_field(query, &GROWTH);
                          input_int_field(query, &weight);
                          input_date_field(query, &birth_date);
                          input_str_field(query, str_buffer, PHONE_NUMBER);
                          input_str_field(query, str_buffer, POSTCODE);
                          input_str_field(query, str_buffer, COUNTRY);
                          input_str_field(query, str_buffer, AREA);
                          input_str_field(query, str_buffer, DISTRICT);
                          input_str_field(query, str_buffer, CITY);
                          input_str_field(query, str_buffer, STREET);
                          input_str_field(query, str_buffer, HOUSE);
                          input_str_field(query, str_buffer, APARTMENT);
                          input_str_field(query, str_buffer, MEDICAL_CARD);
                          input_str_field(query, str_buffer, DIAGNOSIS);
                          input_str_field(query, str_buffer, BLOOD_GROUP);
                          input_str_field(query, str_buffer, DEPARTMENT);
                          input_int_field(query, &PATIENTS_ID);
